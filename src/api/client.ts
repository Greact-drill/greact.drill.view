...
class ApiClient {
  ...
  public async get<T = unknown>(url: string, config: AxiosRequestConfig = {}): Promise<AxiosResponse<T>> {
    try {
      ...
      captureError(error, { method: "GET", url, baseUrl: this.getCurrentUrl() });
      throw error;
    }
  }
  ...
  public async post<T = unknown>(
    ...
    try {
      ...
      captureError(error, { method: "POST", url, baseUrl: this.getCurrentUrl() });
      throw error;
    }
  }
  ...
  public async patch<T = unknown>(
    ...
    try {
      ...
      captureError(error, { method: "PATCH", url, baseUrl: this.getCurrentUrl() });
      throw error;
    }
  }
  ...
  public async delete<T = unknown>(url: string, config: AxiosRequestConfig = {}): Promise<AxiosResponse<T>> {
    try {
      ...
      captureError(error, { method: "DELETE", url, baseUrl: this.getCurrentUrl() });
      throw error;
    }
  }
